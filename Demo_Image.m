%% =========================== Frist part notes ===========================
% Demo for rTVRA algorithm on the real captured image data for the dual-Camera compressive hyperspectral imaging system          
% -------------------------------------------------------------------------
%
%% =========================== Second part notes===========================
...
for sceneIndex = 1:2
    ...
    %Load data
    dataMatname=sprintf('RealData\\Scene%02d.mat', sceneIndex);
    load (dataMatname);
    fprintf('\nReconstructing Scene %02d\n',sceneIndex);
    ...
    recMatname         = sprintf('Results\\rec_Image_Scene%02d.mat', sceneIndex);
